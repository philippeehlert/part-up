(function(g, f) {
  ...
  let h = function(e) {
      ...
      b._generateCookieString = function(a, b, c) {
        ...
        b = String(b).replace(/[^!#$&-+\--:<-\[\]-~]/g, encodeURIComponent);
        c = c || {};
      ...
      b._getCacheFromString = function(a) {
        ...
        for (let c = 0; c < a.length; c++) {
          let e = b._getKeyValuePairFromCookieString(a[c]);
          d[b._cacheKeyPrefix + e.key] === f &&
            (d[b._cacheKeyPrefix + e.key] = e.value);
        }
        return d;
      };
      b._getKeyValuePairFromCookieString = function(a) {
        ...
        try {
          ...
          console &&
            ...
            console.error('Could not decode cookie with key "' + c + '"', f);
        }
      ...
      b._areEnabled = function() {
        let a = '1' === b.set('cookies.js', 1).get('cookies.js');
        b.expire('cookies.js');
        return a;
      };
