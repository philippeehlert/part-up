    ...
    job: function() {
      ...
      Meteor.users
        ...
        .forEach(function(user) {
          ...
          let newNotifications = Notifications.findForUser(user, {
            new: true,
          }).fetch();
          if (newNotifications.length > 0) {
            ...
            let emailOptions = {
              ...
              typeData: {
                ...
                unsubscribeOneUrl:
                  Meteor.absoluteUrl() +
                  'unsubscribe-email-one/dailydigest/' +
            ...
            Meteor.users.update(user._id, {
              $set: { 'flags.dailyDigestEmailHasBeenSent': true },
            });
            counter++;
          }
        });
