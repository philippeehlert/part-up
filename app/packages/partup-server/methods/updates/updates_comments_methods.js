Meteor.methods({
  ...
  'updates.comments.insert': function(updateId, fields) {
    ...
    if (!!update.system) {
      throw new Meteor.Error(403, 'comment_is_not_allowed_on_a_system_update');
    }
    ...
    try {
      ...
      let mentionsWarning = Partup.helpers.mentions.exceedsLimit(
        fields.content
      );
      return {
        _id: comment._id,
