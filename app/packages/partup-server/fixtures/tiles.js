Meteor.startup(function() {
  if (process.env.NODE_ENV.match(/development|staging/)) {
    if (!Tiles.find().count()) {
      ...
      Meteor.users.update('K5c5M4Pbdg3B82wQH', {
        $addToSet: { 'profile.tiles': 'TFxPXWbPFbrEqL5yE' },
      });
      ...
      Meteor.users.update('K5c5M4Pbdg3B82wQH', {
        $addToSet: { 'profile.tiles': 'kshT8u57bA4n4C5gq' },
      });
      ...
      Meteor.users.update('K5c5M4Pbdg3B82wQH', {
        $addToSet: { 'profile.tiles': 'Ywa8cwbwnzuoAh3gK' },
      });
      ...
      Meteor.users.update('K5c5M4Pbdg3B82wQI', {
        $addToSet: { 'profile.tiles': 'oFcBMto69huJwvjqm' },
      });
      ...
      Meteor.users.update('K5c5M4Pbdg3B82wQI', {
        $addToSet: { 'profile.tiles': 'kJw8tAZd6KJvPFGqb' },
      });
      ...
      Meteor.users.update('a7qcp5RHnh5rfaeW9', {
        $addToSet: { 'profile.tiles': 'YPfdhWYRwvzvrfck8' },
      });
    }
  }
});
