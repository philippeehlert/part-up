    ...
    if (!Meteor.users.find().count()) {
      Meteor.users.insert({
        ...
        services: {
          password: {
            bcrypt:
              '$2a$10$nytjhtAbBUXe1Td8LrVJ4.jJa/lE62riuDM/dm79f3fqfeuZo2xNG',
          },
          resume: {
            loginTokens: [
              {
        ...
        profile: {
          ...
          settings: {
            ...
            unsubscribe_email_token:
              'nj8fwDnhzaPSKX4vf-8ZHFyWRL0ZKVRz00ZOrJdB-ug',
          },
          image: 'oQeqgwkdd44JSBSW5',
          description: 'I am the first test user',
          tags: ['education', 'school', 'teaching'],
          location: {
            city: 'Amsterdam',
          ...
          linkedin_url:
            'https://www.linkedin.com/pub/mark-zuckerberg/0/290/362',
        ...
        logins: [new Date('2015-07-21T13:29:39.754Z')],
        networks: [
          'ibn27M3ePaXhmKzWq',
          'kRCjWDBkKru3KfsjW',
          'bmAGcqxmb6izfgXLK',
      ...
      Meteor.users.insert({
        ...
        profile: {
          ...
          settings: {
            ...
            unsubscribe_email_token:
              '6BQGhT9KnxBKAIrn6Y7s565CTOO-SIqfjuHOkJt8ZbQ',
          },
          image: 'cHhjpWKo9DHjXQQjy',
          description: null,
          tags: ['education', 'nonprofit', 'development'],
          location: {
            city: 'Amstelveen',
        ...
        logins: [new Date('2015-07-21T13:43:28.542Z')],
        participation_score: 3,
        pending_networks: [],
        networks: ['wfCv4ZdPe5WNT4xfg'],
        supporterOf: ['vGaxNojSerdizDPjb'],
        upperOf: [
          'CJETReuE6uo2eF7eW',
          'gJngF65ZWyS9f3NDE',
          'vGaxNojSerdizDPjc',
      ...
      Meteor.users.insert({
        ...
        profile: {
          ...
          settings: {
            ...
            unsubscribe_email_token:
              'Xr_FQVj16IQRwpoMxQOWgHMVr5z6Jd04wpvF00n6rK6',
          },
        ...
        logins: [new Date('2015-07-21T13:48:03.641Z')],
        roles: ['admin'],
        networks: [
          'nqBnE8nSLasaapXXS',
          'kRCjWDBkKru3KfsjW',
      ...
      Meteor.users.insert({
        ...
        profile: {
          ...
          settings: {
            ...
            unsubscribe_email_token:
              'WiYdZ-AoYintHgYofjIlOyWTsP8f2oNKLhh3jhhpIdN',
          },
          image: 'bMTGT9oSDGzxCL3r4',
          description: null,
          tags: ['design', 'ux', 'photography', 'nonprofit'],
          location: {
            city: 'Maastricht',
        ...
        logins: [new Date('2015-07-21T14:11:01.103Z')],
        participation_score: 3,
        pending_networks: ['wfCv4ZdPe5WNT4xfg'],
        networks: ['ibn27M3ePaXhmKzWq'],
        upperOf: ['vGaxNojSerdizDPjb', 'vGaxNojSerdizDPjd'],
        supporterOf: ['gJngF65ZWyS9f3NDE'],
        flags: {
          dailyDigestEmailHasBeenSent: false,
        },
      });
      ...
      Meteor.users.insert({
        ...
        profile: {
          ...
          settings: {
            ...
            unsubscribe_email_token:
              'WiYdZ-AoYintHgYofjIlOyWTsP8f2oNKLhh3jhhpIdX',
          },
          image: 'bMTGT9oSDGzxCL3r4',
          description: null,
          tags: ['design', 'ux', 'photography', 'nonprofit'],
      ...
      for (let i = 0; i < 15; i++) {
        let name =
          Fake.fromArray([Fake.word(), Fake.word(), Fake.word(), Fake.word()]) +
          (Math.random(100) > 50
            ? Fake.fromArray([
              Fake.word(),
              Fake.word(),
        ...
        let email = name.replace(' ', '') + '@example.com';
        Meteor.users.insert({
          createdAt: new Date(),
          services: {
            password: {
              ...
              loginTokens: [
                {
                  when: new Date('2015-07-21T13:48:03.566Z'),
                  hashedToken:
                    'vctK9ULMl4Gdegbr+73LED8So83rPz67Xi6KnnNQCV' + i + '=',
                },
              ],
            },
            email: {
          ...
          profile: {
            ...
            settings: {
              ...
              unsubscribe_email_token:
                'Xr_FQVj16IQRwpoMxQOWgHMVr5z6Jd04wpvF00n6rK' + i,
            },
            image: 'CxEprGKNWo6HdrTdq',
            description: null,
            tags: ['administration', 'finance'],
