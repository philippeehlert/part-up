Package.describe({
  summary:
    'Generate an icon font from SVG files. This is not a part-up original package, we just packaged it to include in our iconfont-process',
  version: '0.1.8',
