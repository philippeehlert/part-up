...
Template.Focuspoint.onRendered(function() {
  ...
  let focuspoint_edit = template.find('[data-focuspoint-edit]');
  if (focuspoint_edit) {
    Meteor.setTimeout(function() {
      let view_elms = template.data.view_elm.template.findAll(
        template.data.view_elm.selector
      );
      let button_elm = template.find('[data-focuspoint-button]');
