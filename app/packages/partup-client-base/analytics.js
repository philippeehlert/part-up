let SECOND_TRACKER_NAME = 'newPartupAnalyticsTracker';
let second_tracker_id = get(Meteor, 'settings.public.secondGATracker');
...
Meteor.startup(function() {
  ...
  if (second_tracker_id) {
    analytics.ready(function() {
      // Create 2nd tracker
      let createOptions = { name: SECOND_TRACKER_NAME };
