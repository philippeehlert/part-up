...
(function(exports, undefined) {
  ...
  function define(id, dependencies, definition) {
    ...
    require(dependencies, function() {
      modules[id] = definition(...arguments);
    });
  }
  ...
  function expose(ids) {
    for (let i = 0; i < ids.length; i++) {
      ...
      for (let fi = 0; fi < fragments.length - 1; ++fi) {
...
*/
        ...
        if (i > 0) {
          each(arg, function(value, key) {
            ...
            if (
              ...
              inArray(typeOf(value), ['array', 'object']) !== -1
            ) {
  ...
  define('moxie/core/utils/Env', ['moxie/core/utils/Basic'], function(Basic) {
     ...
     */
    let UAParser = (function(undefined) {
      // ////////////
      // Constants
      // ///////////
      ...
      let UAParser = function(uastring) {
        let ua =
          uastring ||
  ...
  define('moxie/core/utils/Dom', ['moxie/core/utils/Env'], function(Env) {
	...
	*/
    let hasClass = function(obj, name) {
      if (!obj.className) {
        return false;
      }
	...
	@param {String} name Class name
	*/
    let addClass = function(obj, name) {
	...
	@param {String} name Class name
	*/
    let removeClass = function(obj, name) {
      if (obj.className) {
        let regExp = new RegExp('(^|\\s+)' + name + '(\\s+|$)');
  ...
  define('moxie/core/utils/Events', ['moxie/core/utils/Basic'], function(
	...
	*/
    let addEvent = function(obj, name, callback, key) {
      let func, events;
	...
	*/
    let removeEvent = function(obj, name, callback) {
      let type, undef;
	...
	*/
    let removeAllEvents = function(obj, key) {
      if (!obj || !obj[uid]) {
        return;
      }
  ...
  define('moxie/core/utils/Url', [], function() {
	...
	*/
	...
	@return {Boolean}
	*/
    let hasSameOrigin = function(url) {
      function origin(url) {
  ...
  define(
		...
		*/
        ...
        Basic.extend(this, {
          ...
          destroy: function() {
            ...
            let shimContainer = Dom.get(this.shimid);
            if (shimContainer) {
	...
	*/
      Runtime.getInfo = function(uid) {
        let runtime = Runtime.getRuntime(uid);
	...
	*/
      Runtime.thatCan = function(caps, runtimeOrder) {
        let types = (runtimeOrder || Runtime.order).split(/\s*,\s*/);
        for (let i in types) {
        ...
        if (requiredCaps && !Basic.isEmptyObj(modeCaps)) {
          ...
          Basic.each(requiredCaps, function(value, cap) {
            if (modeCaps.hasOwnProperty(cap)) {
              let capMode = modeCaps[cap](value);
          ...
          connectRuntime: function(options) {
            ...
            function initialize(items) {
              ...
              runtime.bind('Exception', function(e, err) {
                ...
                comp.trigger(
                  'RuntimeError',
                  new x.RuntimeError(x.RuntimeError.EXCEPTION_ERR, message)
                );
              });
            ...
            initialize(
              (options.runtime_order || Runtime.order).split(/\s*,\s*/)
            );
          },
  ...
  define(
	...
	*/
      ...
      function FileInput(options) {
        ...
        let container, browseButton, defaults;
          ...
          init: function() {
            ...
            self.bind('RuntimeInit', function(e, runtime) {
              ...
              self.bind('Refresh', function() {
                let pos, size, browseButton, shimContainer, zIndex;
                ...
                if (browseButton) {
                  ...
                  zIndex =
                    parseInt(Dom.getStyle(browseButton, 'z-index'), 10) || 0;
  ...
  define('moxie/core/utils/Encode', [], function() {
	...
	*/
    let utf8_decode = function(str_data) {
  ...
  define(
    ...
    function(
      ...
      Env.global_event_dispatcher =
        'plupload.EventTarget.instance.dispatchEvent';
      ...
      return {
		...
		*/
        ...
        xmlEncode: function(str) {
          ...
          return str
            ? String(str).replace(xmlEncodeRegExp, function(chr) {
...
@private
*/
  define('plupload/core/Collection', ['moxie/core/utils/Basic'], function(
    Basic
  ) {
...
*/
  define(
    ...
    ['moxie/core/utils/Basic', 'moxie/core/EventTarget'],
    function(Basic, EventTarget) {
      let dispatches = ['OptionChanged'];
...
*/
  define(
    ...
    ['moxie/core/utils/Basic', 'plupload/core/Optionable'],
        ...
        Basic.extend(Queueable.prototype, {
          ...
          progress: function(processed, total) {
            ...
            this.percent = Math.min(
              Math.ceil(this.processed / this.total * 100),
              100
            );
...
*/
  define('plupload/core/Stats', [], function() {
    return function() {
       ...
       */
      self.reset = function() {
        self.size = self.total = self.loaded = self.processed = self.uploaded = self.done = self.failed = self.queued = self.processing = self.paused = self.percent = self.bytesPerSec = self.processedPerSec = 0; // deprecated // deprecated // deprecated // deprecated
      };
    };
  });
      ...
      return (function(Parent) {
        ...
        Basic.extend(Queue.prototype, {
          ...
          addItem: function(item) {
            ...
            item.bind('Failed', function() {
              if (
                self.getOption('max_retries') &&
                this.retries < self.getOption('max_retries')
              ) {
                this.stop();
                this.retries++;
              }
          ...
          countSpareSlots: function() {
            return Math.max(
              this.getOption('max_slots') - this.stats.processing,
              0
            );
          },
        ...
        function processNext() {
          ...
          while (self.stats.processing < self.getOption('max_slots')) {
            ...
            if (item) {
              if (
                self.getOption('pause_before_start') &&
                item.state === Queueable.IDLE
              ) {
            ...
            } else if (!self.stats.processing) {
              // we ran out of pending and active items too, so we are done
              self.stop();
        ...
        function calcStats() {
          ...
          self.forEachItem(function(item) {
            ...
            if (self._startTime) {
              self.stats.processedPerSec = Math.ceil(
                self.stats.processed /
                  ((Number(new Date()) - self._startTime || 1) / 1000.0)
              );
              self.stats.bytesPerSec = self.stats.processedPerSec; // for backward compatibility
            }

            if (self.stats.total) {
              self.stats.percent = Math.ceil(
 ...
 */
  define(
    ...
    ['moxie/core/utils/Basic', 'plupload/core/Queue'],
      ...
      return function() {
        ...
        function _read(op, blob) {
          if (blob.isDetached()) {
            ...
            let result = this.connectRuntime(blob.ruid).exec.call(
              this,
              'FileReaderSync',
              'read',
              op,
      ...
      function ChunkUploader(blob, options) {
        ...
        plupload.extend(this, {
          ...
          start: function(options) {
            ...
            url = _options.multipart
              ? _options.url
              : buildUrl(_options.url, _options.params);
            ...
            if (_options.multipart) {
              ...
              if (
                plupload.isEmptyObj(_options.headers) ||
      ...
      function FileUploader(fileRef, queue) {
        ...
        plupload.extend(this, {
          ...
          uploadChunk: function(seq, options, dontStop) {
            let self = this;
            let chunkSize = this.getOption('chunk_size');
            let up;
            let chunk = {};
            let _options;
            ...
            up = new ChunkUploader(
              _file.slice(chunk.start, chunk.end, _file.type),
              _options
            );
          ...
          setOption: function(option, value) {
            if (
              ...
              !this._options.hasOwnProperty(option)
            ) {
              return;
            }
  ...
  define(
	...
	*/
      function Transporter() {
        let mod, _runtime, _data, _size, _pos, _chunk_size;
	...
	*/
      ...
      function Image() {
        ...
        Basic.extend(this, {
          ...
          resize: function(options) {
            ...
            try {
              ...
              orientation =
                (self.meta && self.meta.tiff && self.meta.tiff.Orientation) ||
                1;
              ...
              if (options.crop) {
                ...
                if (options.fit) {
                  ...
                  srcRect.width = Math.min(
                    Math.ceil(options.width / scale),
                    self.width
                  );
                  srcRect.height = Math.min(
                    Math.ceil(options.height / scale),
                    self.height
                  );
          ...
          getAsCanvas: function() {
            ...
            let runtime = this.connectRuntime(this.ruid);
          ...
          getAsBinaryString: function(type, quality) {
            let dataUrl = this.getAsDataURL(type, quality);
            return Encode.atob(
          ...
          embed: function(el, opts) {
            ...
            function render(type, quality) {
              ...
              let dataUrl = img.getAsDataURL(type, quality);
              if (!dataUrl) {
        ...
        function _loadFromImage(img, exact) {
          let runtime = this.connectRuntime(img.ruid);
...
*/
  define(
    ...
    ['plupload', 'plupload/core/Queueable', 'moxie/image/Image'],
      ...
      function ImageResizer(fileRef) {
        ...
        this.start = function(options) {
          ...
          img.bind('resize', function() {
            self.done(
              this.getAsBlob(self.getOption('type'), self.getOption('quality'))
            );
            this.destroy();
          });
  ...
  define(
    ...
    function(plupload, Queueable, FileUploader, ImageResizer) {
      function File(fileRef, queueUpload, queueResize) {
        ...
        plupload.extend(this, {
          ...
          start: function(options) {
            ...
            if (
              !plupload.isEmptyObj(options.resize) &&
              isImage(this.type) &&
              runtimeCan(_file, 'send_binary_string')
            ) {
          ...
          resizeAndUpload: function() {
            let self = this;
            let rszr = new ImageResizer(_file);
          ...
          upload: function() {
            let self = this;
            let up = new FileUploader(_file, queueUpload);
      ...
      function runtimeCan(blob, cap) {
        if (blob.ruid) {
          let info = plupload.Runtime.getInfo(blob.ruid);
          if (info) {
            return info.can(cap);
          }
        }
  ...
  define(
    ...
    function(
      ...
      function Uploader(options) {
        ...
        let _fileInputs = [];
        let _fileDrops = [];
        let _queueUpload, _queueResize;
        let _initialized = false;
        let _disabled = false;

        let _options = plupload.extend(
          {
        ...
        _options.required_features = normalizeCaps(
          plupload.extend({}, _options)
        );

        // Come up with the list of capabilities that can affect default mode in a multi-mode runtimes
        _options.preferred_caps = normalizeCaps(
          plupload.extend({}, _options, {
        ...
        plupload.extend(this, {
          ...
          init: function() {
                ...
                if (self.getOption(el) === null) {
                  err = {
                    ...
                    message: plupload.sprintf(
                      plupload.translate('%s specified, but cannot be found.'),
                      el
                    ),
                  };
                  return false;
            ...
            if (
              !self.getOption('browse_button') &&
              !self.getOption('drop_element')
            ) {
            ...
            initControls.call(self, function(initialized) {
              let runtime;
              let initOpt = self.getOption('init');
              let queueOpts = plupload.extend({}, self.getOption(), {
                auto_start: true,
              });
            ...
            if (_initialized) {
              ...
              if (
                ...
                return this.trigger('Error', {
                  ...
                  message: plupload.sprintf(
                    plupload.translate('%s option cannot be changed.')
                  ),
                  option: option,
                });
              }
          ...
          addFile: function(file, fileName) {
            let self = this;
            let queue = [];
            let ruid; // spare runtime uid, for those files that do not have their own
            let filesAdded = []; // here we track the files that got filtered and are added to the queue
          ...
          removeFile: function(file) {
            let item = this.extractItem(
              typeof file === 'string' ? file : file.uid
            );
            if (item) {
          ...
          splice: function(start, length) {
            ...
            let i = 0;
            let removed = [];
            let shouldRestart = plupload.STARTED == this.state;

            start === undef ? 0 : Math.max(start, 0);
            let end =
              length === undef
                ? this.count()
                : Math.min(start + length, this.count());
        ...
        if (_options.backward_compatibility) {
          ...
          this.bind(
            'OptionChanged',
            function(up, name, value) {
              up.settings[name] =
                typeof value == 'object' ? plupload.extend({}, value) : value;
            },
            this,
            999
          );
        ...
        function getRUID() {
          let ctrl = _fileInputs[0] || _fileDrops[0];
          if (ctrl) {
        ...
        function initControls(cb) {
          ...
          plupload.each(self.getOption('runtimes').split(/\s*,\s*/), function(
            runtime
          ) {
            ...
            plupload.each(self.getOption('browse_button'), function(el) {
              queue.push(function(cb) {
                ...
                fileInput.onready = function() {
                  let info = Runtime.getInfo(this.ruid);
                    ...
                    if (!_disabled) {
                      if (self.getOption('browse_button_hover')) {
                        if ('mouseenter' === e.type) {
                          plupload.addClass(
                            el,
                            self.getOption('browse_button_hover')
                          );
                      ...
                      if (self.getOption('browse_button_active')) {
                        if ('mousedown' === e.type) {
                          plupload.addClass(
                            el,
                            self.getOption('browse_button_active')
                          );
      ...
      function normalizeCaps(settings) {
        let features = settings.required_features,
          caps = {};
...
*/
  define(
    ...
    function(extensions, File, Basic, Dom, Events, Mime, Env) {
      function FileInput() {
        let _options, _browseBtnZIndex; // save original z-index
            ...
            switch (name) {
              case 'accept':
                if (value) {
                  let mimes =
                    value.mimes ||
                    Mime.extList2mimes(value, I.can('filter_by_extension'));
      ...
      function FileDrop() {
        ...
        function _addFile(file, relativePath) {
          if (_isAcceptable(file)) {
            let fileObj = new File(_ruid, file);
      ...
      function XMLHttpRequest() {
            ...
            if (!mustSendAsBinary) {
              ...
              if (_xhr.sendAsBinary) {
                ...
                (function() {
                  ...
                  let ui8a = new Uint8Array(data.length);
        ...
        function _getNativeXHR() {
          if (
            ...
            return (function() {
              let progIDs = ['Msxml2.XMLHTTP.6.0', 'Microsoft.XMLHTTP']; // if 6.0 available, use it, otherwise failback to default 3.0
        ...
        function _prepareMultipart(fd) {
          let boundary = '----moxieboundary' + new Date().getTime(),
            dashdash = '--',
            crlf = '\r\n',
            multipart = '',
            I = this.getRuntime();
  ...
  define(
    ...
    function(Basic, BinaryReader, x) {
      function ExifParser(data) {
        let __super__, tags, tagDescs, offsets, idx, Tiff;
        ...
        Basic.extend(this, {
          ...
          thumb: function() {
            if (offsets.IFD1) {
              try {
                let IFD1Tags = extractTags.call(this, offsets.IFD1, tags.thumb);
        ...
        function setTag(ifd, tag, value) {
          ...
          if (typeof tag === 'string') {
            let tmpTags = tags[ifd.toLowerCase()];
            for (let hex in tmpTags) {
              if (tmpTags[hex] === tag) {
                tag = hex;
                break;
              }
...
*/
  ...
  define('moxie/runtime/html5/image/ResizerCanvas', [], function() {
    function scale(image, ratio) {
      ...
      let tCanvas = _scale(image, ratio);
  ...
  define('moxie/runtime/html5/image/ResizerWebGL', [], function() {
    function scale(image, ratio) {
      let dW = Math.floor(image.width * ratio);
      let dH = Math.floor(image.height * ratio);
      let canvas = document.createElement('canvas');
      canvas.width = dW;
      canvas.height = dH;
    ...
    function _drawImage(canvas, image, wRatio, hRatio) {
      ...
      let uResolution = gl.getUniformLocation(program, 'u_wh');
      gl.uniform2f(uResolution, image.width, image.height);

      let uRatio = gl.getUniformLocation(program, 'u_ratio');
        ...
        Runtime.call(
          ...
          type,
          {
            ...
            return_response_type: function(responseType) {
              ...
              return (
                !Basic.arrayDiff(responseType, ['', 'text', 'document']) ||
                I.mode === 'browser'
              );
            },
      ...
      let FileInput = {
        init: function(options) {
          ...
          this.bind(
            'Change',
            function() {
              let files = I.shimExec.call(comp, 'FileInput', 'getFiles');
              comp.files = [];
    ...
    function(extensions, Encode) {
      ...
      let FileReader = {
        read: function(op, blob) {
          ...
          return comp
            .getRuntime()
            .shimExec.call(this, 'FileReader', 'readAsBase64', blob.uid);
        },
      };
      ...
      function isInstalled(version) {
        ...
        try {
          try {
            ...
            let plugin = navigator.plugins['Silverlight Plug-In'];
      ...
      let FileDrop = {
        init: function() {
          ...
          Events.addEvent(
            ...
            function(e) {
              e.preventDefault();
              let flag = Dom.get(self.uid).dragEnter(e);
          ...
          Events.addEvent(
            ...
            function(e) {
              e.preventDefault();
              let flag = Dom.get(self.uid).dragDrop(e);
              // If handled, then stop propagation of event in DOM
              if (flag) {
                e.stopPropagation();
              }
...
*/
  define(
    ...
    function(
      ...
      Basic,
      XMLHttpRequest,
      FileReaderSyncSilverlight,
      TransporterSilverlight
    ) {
      ...
      function XMLHttpRequest() {
        ...
        function cleanup(cb) {
          ...
          setTimeout(function() {
            ...
            let shimContainer = target.getRuntime().getShimContainer();
        ...
        Basic.extend(this, {
          send: function(meta, data) {
            ...
            function createIframe() {
              let container = I.getShimContainer() || document.body,
