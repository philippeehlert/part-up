...
Partup.client.language = {
  ...
  change: function(language) {
    ...
    let currentLanguage = self.current.get();
    ...
    TAPi18n.setLanguage(language)
      .done(function() {
        ...
        Partup.client.datepicker.options.format = moment
          .localeData()
          .longDateFormat('L')
          .toLowerCase();
        ...
        SimpleSchema.messages({
          ...
          individualMaxString: TAPi18n.__(
            'base-client-language-ss-individualMaxString'
          ),
          ...
          expectedBoolean: TAPi18n.__(
            'base-client-language-ss-expectedBoolean'
          ),
          ...
          expectedConstructor: TAPi18n.__(
            'base-client-language-ss-expectedConstructor'
          ),
          ...
          regEx: [
            ...
            {
              exp: Partup.services.validators.email,
              msg: TAPi18n.__('base-client-language-ss-regex-Email'),
            },
            {
              exp: SimpleSchema.RegEx.Domain,
              msg: TAPi18n.__('base-client-language-ss-regex-Domain'),
            },
            {
              exp: SimpleSchema.RegEx.WeakDomain,
              msg: TAPi18n.__('base-client-language-ss-regex-WeakDomain'),
            },
            {
              exp: SimpleSchema.RegEx.IP,
              msg: TAPi18n.__('base-client-language-ss-regex-IP'),
            },
            {
              exp: SimpleSchema.RegEx.IPv4,
              msg: TAPi18n.__('base-client-language-ss-regex-IPv4'),
            },
            {
              exp: SimpleSchema.RegEx.IPv6,
              msg: TAPi18n.__('base-client-language-ss-regex-IPv6'),
            },
            {
              exp: SimpleSchema.RegEx.Url,
              msg: TAPi18n.__('base-client-language-ss-regex-Url'),
            },
            {
              exp: SimpleSchema.RegEx.Id,
              msg: TAPi18n.__('base-client-language-ss-regex-Id'),
            },
          ],
          passwordMismatch: TAPi18n.__(
            'base-client-language-ss-passwordMismatch'
          ),
          emailExists: TAPi18n.__('base-client-language-ss-emailExists'),
          emailNotFound: TAPi18n.__('base-client-language-ss-emailNotFound'),
          passwordIncorrect: TAPi18n.__(
            'base-client-language-ss-passwordIncorrect'
          ),
          shouldNotContainHtml: TAPi18n.__(
            'base-client-language-ss-shouldNotContainHtml'
          ),
          missingRequiredTags: TAPi18n.__(
            'base-client-language-ss-missingRequiredTags'
          ),
          shouldNotContainUrls: TAPi18n.__(
            'base-client-language-ss-shouldNotContainUrls'
          ),
        });
      ...
      .fail(function(error_message) {
        Partup.client.notify.error(
          'Could not load the language "' + language + '"'
        );
      });
  },
  /**
  ...
  getBrowserDefaultLocale: function() {
    let language = 'en';
    if (TAPi18n && Partup) {
      let detectedLocale = navigator.userLanguage || navigator.language;
