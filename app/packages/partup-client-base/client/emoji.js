(function(local_setup) {
  ...
  emoji.replace_emoticons_with_colons = function(str) {
    emoji.init_emoticons();
    return str.replace(emoji.rx_emoticons, function(m, $1, $2) {
      let val = emoji.data[emoji.map.emoticons[$2]][3][0];
      return val ? $1 + ':' + val + ':' : m;
    });
  };
  ...
  emoji.replace_colons = function(str) {
    ...
    return str.replace(emoji.rx_colons, function(m) {
      ...
      if (idx.indexOf('::skin-tone-') > -1) {
        ...
        let skin_val = emoji.map.colons[skin_idx];
  ...
  emoji.init_emoticons = function() {
    ...
    let a = [];
    emoji.map.emoticons = {};
    for (let i in emoji.emoticons_data) {
  ...
  emoji.init_colons = function() {
    ...
    emoji.map.colons = {};
    for (let i in emoji.data) {
      for (let j = 0; j < emoji.data[i][3].length; j++) {
  ...
  emoji.init_unified = function() {
    ...
    for (let i in emoji.data) {
      for (let j = 0; j < emoji.data[i][0].length; j++) {
