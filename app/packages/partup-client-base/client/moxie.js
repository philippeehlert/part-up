...
!(function(e, t) {
  ...
  i(u, [], function() {
    var e = function(e) {
      ...
      s = function(t, n) {
        ...
        for (let r in t) -1 === a(t[r], n) && i.push(t[r]);
        return i.length ? i : !1;
      },
      u = function(e, t) {
        let i = [];
    ...
    var n = (function(e) {
        let t = '',
          ...
          v = {
            rgx: function() {
              for (
                var t, n = 0, a, s, u, c, l, d, h = arguments;
                n < h.length;
                n += 2
              ) {
                let f = h[n],
          ...
          y = {
            ...
            os: [
              ...
              [[u, 'Windows'], [d, v.str, w.os.windows.version]],
              [/\((bb)(10);/i],
              [[u, 'BlackBerry'], d],
              [
                /(blackberry)\w*\/?([\w\.]+)*/i,
    ...
    function i() {
      ...
      n.extend(this, {
        ...
        hasEventListener: function(t) {
          let n = t ? e[this.uid] && e[this.uid][t] : e[this.uid];
          return n ? n : !1;
        },
        removeEventListener: function(t, i) {
          t = t.toLowerCase();
          let r = e[this.uid] && e[this.uid][t],
            o;
          if (r) {
            if (i) {
        ...
        handleEventProps: function(e) {
          ...
          this.bind(e.join(' '), function(e) {
            let t = 'on' + e.type.toLowerCase();
            'function' === n.typeOf(this[t]) &&
  ...
  i(m, [c, u, h, p], function(e, t, n, i) {
    ...
    return (
      ...
      (r.thatCan = function(e, t) {
        let n = (t || r.order).split(/\s*,\s*/);
        for (let i in n) if (r.can(n[i], e)) return n[i];
        return null;
      }),
      (r.getMode = function(e, n, i) {
        let r = null;
        if (
          ('undefined' === t.typeOf(i) && (i = 'browser'),
            n && !t.isEmptyObj(e))
        ) {
          if (
      ...
      n.extend(this, {
        connectRuntime: function(r) {
          ...
          if (
            ('string' === n.typeOf(r)
              ? (s = r)
              : 'string' === n.typeOf(r.ruid) && (s = r.ruid),
              s)
          ) {
    ...
    function c(t) {
      ...
      e.extend(o, {
        ...
        init: function() {
          ...
          o.connectRuntime(
            e.extend({}, t, {
              required_caps: { select_file: !0 },
            })
          );
        },
        disable: function(t) {
          let n = this.getRuntime();
          n &&
                n.exec.call(
                  this,
                  'FileInput',
      ...
      function i(e, i) {
        ...
        if (!(i instanceof r)) {
          return (
            this.trigger(
              'error',
              new n.DOMException(n.DOMException.NOT_FOUND_ERR)
            ),
            void this.trigger('loadend')
          );
        }
  ...
  i(A, [u, g, w], function(e, t, n) {
    return function() {
      function i(e, t) {
        if (!t.isDetached()) {
          let i = this.connectRuntime(t.ruid).exec.call(
            this,
            'FileReaderSync',
            'read',
            e,
  ...
  i(T, [u, f, p, w, x, m, R, y, A, I, c, d], function(
    e,
    t,
    n,
    i,
    ...
    function f() {
      ...
      function u(t) {
        ...
        function r(r) {
          ...
          B.bind('Load', function(t) {
            ...
            n(
              'status',
              Number(r.exec.call(B, 'XMLHttpRequest', 'getStatus') || 0)
            ),
        ...
        (C = new Date().getTime()),
        (B = new a()),
        'string' == typeof H.required_caps &&
              (H.required_caps = o.parseCaps(H.required_caps)),
      ...
      e.extend(this, w, {
        ...
        send: function(n, r) {
          if (
            ((H = 'string' === e.typeOf(r) ? { ruid: r } : r ? r : {}),
          ...
          this.withCredentials ||
              (this.withCredentials =
                H.required_caps && H.required_caps.send_browser_cookies && !L),
        ...
        destroy: function() {
          B &&
              ('function' === e.typeOf(B.destroy) && B.destroy(), (B = null)),
          this.unbindAll(),
  ...
  i(O, [u, h, f, A, T, m, g, S, c, p, y, E, w], function(
    e,
    t,
    n,
    i,
    ...
    function f() {
      ...
      function m(t, n) {
        let i = this.connectRuntime(t.ruid);
        (this.ruid = i.uid),
        i.exec.call(
          this,
          'Image',
      ...
      e.extend(this, {
        ...
        getAsCanvas: function() {
          ...
          let e = this.connectRuntime(this.ruid);
        ...
        embed: function(i, r) {
          ...
          try {
            ...
            return (
              ...
              this.meta.thumb &&
                  this.meta.thumb.width >= r.width &&
                  this.meta.thumb.height >= r.height
            ...
            select_multiple: function() {
              return !(
                !r.can('select_file') ||
                  ...
                  ('iOS' === i.os &&
                    i.verComp(i.osVersion, '7.0.0', '>') &&
                    i.verComp(i.osVersion, '8.0.0', '<'))
              );
            },
    ...
    function s() {
      ...
      n.extend(this, {
        init: function(s) {
          ...
          (h =
                e.accept.mimes ||
                o.extList2mimes(e.accept, c.can('filter_by_extension'))),
          ...
          (d.innerHTML =
                ...
                (e.directory && c.can('select_folder')
                ...
                n.each(this.files, function(n) {
                  ...
                  return e.directory && '.' == n.name
                    ...
                    : (n.webkitRelativePath &&
                          (i = '/' + n.webkitRelativePath.replace(/^\//, '')),
                      (n = new t(c.uid, n)),
                      (n.relativePath = i),
                      void u.files.push(n));
                }),
  ...
  i(M, [D, E, u, h, N, d], function(e, t, n, i, r, o) {
    function a() {
      function e(e) {
        ...
        let t = n.toArray(e.dataTransfer.types || []);
        return (
          -1 !== n.inArray('Files', t) ||
      ...
      function u(e) {
        ...
        let t = o.getFileExtension(e.name);
        ...
        read: function(t, o) {
          ...
          'function' === n.typeOf(i[t])
            ...
            : 'readAsBinaryString' === t &&
                  ((r = !0), i.readAsDataURL(o.getSource()));
        },
        abort: function() {
          i && i.abort();
        },
    ...
    function c() {
      ...
      function c() {
        return !window.XMLHttpRequest ||
          ...
          ? (function() {
            for (
              let e = ['Msxml2.XMLHTTP.6.0', 'Microsoft.XMLHTTP'], t = 0;
              t < e.length;
              t++
            ) {
              try {
      ...
      function d(e) {
        let t = '----moxieboundary' + new Date().getTime(),
          n = '--',
          i = '\r\n',
          r = '',
          a = this.getRuntime();
                ...
                case 3:
                  ...
                  try {
                    i.hasSameOrigin(n.url) &&
                          (e = f.getResponseHeader('Content-Length') || 0),
          ...
          switch (arguments.length) {
            ...
            case 3:
              if (
                ...
                let o = new Uint8Array(this.length() - i + r.byteLength);
    ...
    return (
      e.extend(t.prototype, {
        ...
        read: function(e, t) {
          ...
          for (
            i = this.littleEndian ? 0 : -8 * (t - 1), r = 0, n = 0;
            t > r;
            r++
          ) {
        ...
        o.clear(),
        {
          ...
          set: function(e, t) {
            ...
            for (
              ...
              a = r.length;
              a > i &&
                (r[i].name === e.toUpperCase() &&
                  ((r[i].segment = n[o]), (r[i].length = n[o].length), o++),
                  !(o >= n.length));
              i++
            );
          },
    ...
    function r(o) {
      function a(n, r) {
        ...
        for (a = o.SHORT(n), s = 0; a > s; s++) {
          if (
            ((g = []), (p = n + 2 + 12 * s), (u = r[o.SHORT(p)]), u !== t)
          ) {
            if (
              ((c = w[o.SHORT((p += 2))]),
                (h = o.LONG((p += 2))),
            ...
            'ASCII' !== c
              ? ((g = o.asArray(c, p, h)),
                (m = 1 == h ? g[0] : g),
                l.hasOwnProperty(u) && 'object' != typeof m
                  ? (v[u] = l[u][m])
                  : (v[u] = m))
        ...
        (n.call(this, o),
          ...
          e.extend(this, {
            ...
            thumb: function() {
              if (d.IFD1) {
                try {
                  let e = a.call(this, d.IFD1, c.thumb);
          ...
          65505 !== this.SHORT(0) ||
            'EXIF\x00' !== this.STRING(4, 5).toUpperCase())
      ) {
        throw new i.ImageError(i.ImageError.INVALID_META_ERR);
      }
      if (
      ...
      let p = this.LONG(d.IFD0 + 12 * this.SHORT(d.IFD0) + 2);
    ...
    function o(o) {
      function a(e) {
        ...
        for (e || (e = c); t <= e.length(); ) {
          if (((n = e.SHORT((t += 2))), n >= 65472 && 65475 >= n)) {
            return (t += 5), { height: e.SHORT(t), width: e.SHORT((t += 2)) };
          }
          (i = e.SHORT((t += 2))), (t += i - 2);
        }
        return null;
      ...
      function s() {
        let e = d.thumb(),
          t,
          n;
        return e && ((t = new i(e)), (n = a(t)), t.clear(), n)
          ? ((n.data = e), n)
          : null;
      }
      function u() {
        d &&
            l &&
            c &&
            (d.clear(), l.purge(), c.clear(), (h = l = d = c = null));
      }
      let c, l, d, h;
  ...
  i(j, [D, u, f, w, y, E, z, q, d, c], function(
    e,
    t,
    n,
    i,
    ...
    function l() {
      ...
      function m(e, t, n, i, r, o) {
        if ('iOS' === c.OS) {
          s.renderTo(e, t, { width: r, height: o, x: n, y: i });
        } else {
  ...
  i(X, [u, c, h, f, m], function(e, t, n, i, r) {
    ...
    function s(e) {
      let t = n.get(e);
      if (t) {
        for (let i in t) 'function' == typeof t[i] && (t[i] = null);
    ...
    function u(s) {
      let u = this,
        d;
      (s = e.extend({ swf_url: t.swf_url }, s)),
      r.call(
        this,
        s,
        c,
    ...
    let i = {
      init: function(e) {
        ...
        this.bind(
          'Change',
          function() {
            let e = r.shimExec.call(i, 'FileInput', 'getFiles');
            (i.files = []),
            n.each(e, function(e) {
    ...
    function o(e) {
      ...
      try {
        try {
          ...
          let l = navigator.plugins['Silverlight Plug-In'];
          if (l) {
            for (
              i = l.description,
    ...
    let i = {
      init: function(e) {
        ...
        this.bind(
          'Change',
          function() {
            let e = o.shimExec.call(r, 'FileInput', 'getFiles');
            (r.files = []),
            n.each(e, function(e) {
    ...
    function s() {
      ...
      n.extend(this, {
        init: function(t) {
          ...
          (u =
                t.accept.mimes ||
                o.extList2mimes(t.accept, a.can('filter_by_extension'))),
          (s = a.getShimContainer()),
          (function() {
            let e, o, u;
            (e = i.get(t.browse_button)),
            a.can('summon_file_dialog') &&
                    ('static' === i.getStyle(e, 'position') &&
  ...
  i(de, [ue, u, h, x, f, N, y, I], function(e, t, n, i, r, o, a, s) {
    function u() {
      function e(e) {
        ...
        if (l) {
          ...
          setTimeout(function() {
            ...
            let n = t.getRuntime().getShimContainer();
      ...
      t.extend(this, {
        send: function(d, h) {
          function f() {
            let n = m.getShimContainer() || document.body,
              r = document.createElement('div');
            (r.innerHTML =
                '<iframe id="' +
                g +
...
mOxie.Env.swf_url = '/files/flash/Moxie.min.swf';
mOxie.Env.xap_url = '/files/silverlight/Moxie.xap';
