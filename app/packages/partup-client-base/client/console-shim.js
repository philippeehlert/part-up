...
(function() {
   ...
   *            The bound function.
   */
  let bind = function(func, scope, args) {
    let fixedArgs = Array.prototype.slice.call(arguments, 2);
    return function() {
      let args = fixedArgs.concat(Array.prototype.slice.call(arguments, 0));
  ...
  let console = /** @type {Object} */ window.console;
  ...
  if (
    window['__consoleShimTest__'] != null ||
