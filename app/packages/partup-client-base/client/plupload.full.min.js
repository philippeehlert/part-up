...
!(function(e, t) {
      ...
      n = function(e, t) {
        ...
        if (e) {
          ...
          if (n === o) {
            ...
            for (r = 0; n > r; r++) if (t(e[r], r) === !1) return;
          }
        }
      },
      i = function(t) {
                        ...
                        ? 2 == c.length
                          ...
                          : 3 == c.length
                            ? (t[c[0]] =
                                    typeof c[1] !== i ||
                                    (c[1].exec && c[1].test)
                                      ? d ? d.replace(c[1], c[2]) : e
                                      : d ? c[1].call(this, d, c[2]) : e)
                            : 4 == c.length &&
                                  (t[c[0]] = d
  ...
  i(g, [u, f, p], function(e, t, n) {
    ...
    return (
      ...
      (i.thatCan = function(e, t) {
        let n = (t || i.order).split(/\s*,\s*/);
        for (let r in n) if (i.can(n[r], e)) return n[r];
        return null;
      }),
        ...
        init: function() {
          ...
          c.bind('RuntimeInit', function(t, i) {
            ...
            c.bind(
              'Change',
              function() {
                let t = i.exec.call(c, 'FileInput', 'getFiles');
                (c.files = []),
                e.each(t, function(e) {
                  return 0 === e.size
                    ? !0
        ...
        init: function() {
          ...
          a.bind('RuntimeInit', function(e, t) {
            ...
            a.bind(
              'Drop',
              function() {
                let e = t.exec.call(a, 'FileDrop', 'getFiles');
                (a.files = []),
                i.each(e, function(e) {
  ...
  i(S, [u, h, p, m, R, g, x, y, T, A, d, l], function(
    e,
    t,
    n,
    i,
  ...
  i(I, [u, f, h, T, S, g, v, O, d, p, y, w, m], function(
    e,
    t,
    n,
    i,
  ...
  i(C, [D, u, f, L, l], function(e, t, n, i, r) {
    function o() {
      function e(e) {
        ...
        let n = t.toArray(e.dataTransfer.types || []);
        return (
          -1 !== t.inArray('Files', n) ||
      ...
      function a(e) {
        ...
        let n = r.getFileExtension(e.name);
...
(function(e, t, n) {
  ...
  (o.Uploader = function(e) {
    ...
    function E(e, n) {
      if (e.ruid) {
        let r = t.Runtime.getInfo(e.ruid);
        if (r) return r.can(n);
      }
      return !1;
    }
    ...
    function x(e, n) {
      ...
      e.browse_button &&
            o.each(e.browse_button, function(n) {
              s.push(function(s) {
                ...
                (a.onready = function() {
                  let e = t.Runtime.getInfo(this.ruid);
                  t.extend(r.features, {
      ...
      e.drop_element &&
            o.each(e.drop_element, function(e) {
              s.push(function(n) {
                let s = new t.FileDrop(o.extend({}, u, { drop_zone: e }));
                (s.onready = function() {
                  let e = t.Runtime.getInfo(this.ruid);
    ...
    function A(e) {
      if (e.state == o.STARTED) p = Number(new Date());
      else if (e.state == o.STOPPED) {
        for (let t = e.files.length - 1; t >= 0; t--) {
    ...
    o.extend(this, {
      ...
      splice: function(e, t) {
        let r = f.splice(e === n ? 0 : e, t === n ? f.length : t),
          i = !1;
        return (
          this.state == o.STARTED &&
                (o.each(r, function(e) {
  ...
  (o.File = (function() {
    function n(n) {
      o.extend(this, {
        ...
        getNative: function() {
          let e = this.getSource().getSource();
