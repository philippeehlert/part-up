...
Template.update_partups_budget_changed.helpers({
  oldBudget: function() {
    ...
    return template.budgetDisplay(
      this.type_data.old_type,
      this.type_data.old_value,
      this.type_data.old_currency
    );
  },
  ...
  newBudget: function() {
    let template = Template.instance();
    return template.budgetDisplay(
      this.type_data.new_type,
      this.type_data.new_value,
      this.type_data.new_currency
    );
  },
});
