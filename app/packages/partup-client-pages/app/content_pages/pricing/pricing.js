let UpperProduct = function(type) {
  ...
  this.price_info = TAPi18n.__(
    'pages-app-pricing-upper-' + type + '-price-info'
  );
  this.features = [
    {
...
let TribeProduct = function(type, more) {
  ...
  this.price_info = TAPi18n.__(
    'pages-app-pricing-tribe-' + type + '-price-info'
  );
  this.features = [
    {
      ...
      more: more
        ? TAPi18n.__('pages-app-pricing-tribe-' + type + '-feature1-more')
        : false,
    },
    {
...
Template.app_pricing.helpers({
  ...
  upper_products: function() {
    return [new UpperProduct('upper'), new UpperProduct('premiumupper')];
  },
