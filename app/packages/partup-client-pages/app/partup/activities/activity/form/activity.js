...
Template.activityForm.events({
  ...
  'click [data-archive]'(event, templateInstance) {
    Meteor.call('activities.archive', templateInstance.activity._id, function(
      error,
      result
    ) {
  ...
  'click [data-remove]'(event, templateInstance) {
    Meteor.call('activities.remove', templateInstance.activity._id, function(
      error,
      result
    ) {
      templateInstance.destroy();
          ...
          if (result && result._id) {
            try {
              ...
              if (
                ...
                typeof activityForm.data.createCallback === 'function'
              ) {
